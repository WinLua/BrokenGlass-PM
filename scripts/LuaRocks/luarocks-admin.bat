...
IF NOT "%LUA_PATH_5_2%"=="" (
   SET "LUA_PATH_5_2=C:\Program Files (x86)\LuaRocks\lua\?.lua;C:\Program Files (x86)\LuaRocks\lua\?\init.lua;%LUA_PATH_5_2%"
)
IF NOT "%LUA_PATH_5_3%"=="" (
   SET "LUA_PATH_5_3=C:\Program Files (x86)\LuaRocks\lua\?.lua;C:\Program Files (x86)\LuaRocks\lua\?\init.lua;%LUA_PATH_5_3%"
)
SET "PATH=C:\Program Files (x86)\LuaRocks;%PATH%"
"C:\Program Files (x86)\PUC-Lua\5.3\bin\lua.exe" "C:\Program Files (x86)\LuaRocks\luarocks-admin.lua" %*
